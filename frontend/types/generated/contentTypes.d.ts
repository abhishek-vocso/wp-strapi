...
export interface ApiSiteSite extends Schema.CollectionType {
  ...
  attributes: {
    ...
    postData: Attribute.JSON;
    pageData: Attribute.JSON;
    appData: Attribute.JSON;
    pricingFilterData: Attribute.JSON;
    cfCategoryData: Attribute.JSON;
    demo1Data: Attribute.JSON;
    postMedia: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
